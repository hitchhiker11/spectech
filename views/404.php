...
<html lang="en" class="light-style " dir="ltr" data-theme="theme-default" data-assets-path="/views/assets/" data-template="vertical-menu-template-free">
...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
<link rel="stylesheet" href="/views/assets/vendor/css/pages/page-misc.css">
    <!-- Helpers -->
...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    ...
    <p class="mb-4 mx-2">Упс! 😖 Запрошенный URL не найден на сервере!</p>
